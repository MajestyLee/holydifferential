...
<div id="wrap">
	...
	<div id="leftside">
		...
		<ul class="avmenu">
			...
			<li><a href="batch.php" class="current">Batch Query</a></li>
  ...
  <h2> &nbsp; Batch Query</h2>
	  ...
	  The uploaded file(.txt) contains a list of locations,fommatted as below:
Chromosome number, start position, end position
 </p>
	  	
		
		<div style="width:500px">
			<blockquote><p>Chromosome number, start position, end position</br>
chr1,10001,19001</br>
chrx,190001,209991</p></blockquote>
		...
		<form method="post" action="out.php" onsubmit="return check()" enctype="multipart/form-data">
          <div>
									  ...
									  <p><input type="checkbox" name="celltype[]" value="H1_cell_line" onclick="newcell()"/>
									    ...
									    H1_Derived_Trophoblast_Cultured_Cells   
									    &nbsp;
		  <p>
			  ...
			  <div>
			   ...
			   <div>	
                <a>Regions:</a>
										<p>
										<a>Input Box->></a>&nbsp; 
										<input name="yu" type="text" id="yu" value="chr1,10001,19001;chr3,10001,19001" onblur="ExistsData()" style="width:600px; height:50px"/>
									
										  
  &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
  <input name="submit2" type="submit"  value="search and export" id="rrb" />
		  
    </form>
			
	<a>Upload File->></a>
	<input type="file" name="file1" id="file" onblur="ExistsData1()" value="File" />
 &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;   
 <input type="submit" name="submit5" value="search and export" />
  &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
  </form>
...
return $a;
	...
	if(isset($_POST['submit2']))//细胞系的查询
	{//7
	$file = $_POST['yu'];
 //$content = file_get_contents($file);//读取文件
 $lo = explode(";", $file);
 $nl=count($lo);//总共的行数
print_r($lo);
...
function search($chr,$loca1,$loca2,$s,&$hg)// 一行location的查询调用函数,h1用于存储查询的结果，h1[location区域][location单点+单点对应的106个值]
{ //2
$s1='location'.','.$s;
...
?>
	  ...
	  <p>Upload the exporting result and choose the bin size,W-Chipeaks is available
	  		</p>

   	
		</form>
			<form method="post" action="peak.php" enctype="multipart/form-data">						
              <p>
  <input type="file" name="file" id="file" onblur="ExistsData1()" value="Result" />
                  <select name="se" >
                          <option value="2">Bin_size(2)</option>
                  <option value="4">Bin_size(4)</option>
                  <option value="5">Bin_size(5)</option>
                </select> 
  <input type="submit" name="submit56" value="Upload" />
   <blockquote>
			<a>FILE FORMAT FOR W-Chipeaks:</a></br>Chr,Start Location,End Location</br>Location,Tag Num</br>10001,3</br> 10201,4</br>Chr,Start Location,End Location</br>.....</b>
	  </blockquote>	
  &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
  </form>
  <?php
