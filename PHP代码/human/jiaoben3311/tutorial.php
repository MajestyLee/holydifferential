...
alert('Qucik Choose all modification type in H1_Cell_Line');
for(var a=0;a<18;a++)
{
am(b[a]);
...
//for(var r=0;r<28;r++)
{//if
alert('Intersection with H1_Cell_Line');
    var a = document.getElementsByName('a[]');
    for(var r=0;r<30;r++)
	{//1
	if(a[r].checked==true)
...
<div id="wrap">
	...
	<div id="leftside">
		<h2 class="hide">Sample menu:</h2>
			...
			<li><a href="mrna.php">mRNA Data</a></li>
  ...
  <table width="50%" height="185">
		...
		<tbody>
			...
			<tr>
				<th scope="row"><a href="">mRNA Data</a></th>
				<td>cell type;chrmosome</td>
				<td>tendency chart</td>
		    </tr>
		</tbody>
  </table>
...
<li>Sort the result: Press this button, you can sort the result. </li>
<li>Visualize: Press this button, you can visualize and compare the histone modification states. By clicking the cell_type_histone modification line on the right, you can hide the correponding curve.</li>
<img src="img/single3.png" alt="" width="681" height="215" />
<li>attributes:cell type_modification on the right can be zoomed.</li>

<h3> 3.Batch Query Page(input)</h3>
<img src="img/batch1.png" alt="" width="681" height="727" />
<li>Cell Type: It is required to select one or more cell types.</li> 
...
<h3> 5.Visualization Page(input)</h3>
...
<li>Cell Type: It is required to select one or more cell types. </li>
<li>Histone modification: The related histone modification types are selected automatically when the query cell types are selected. You can also cancel the selection of histon modification marks.</li>
<li>Chromosome: Visualize genome-wide histone modification states by chromosome.</li>
<h3> 6.Visualization Page(output)</h3>
<img src="img/visualize2.png" alt="" width="681" height="825" />
<li>Each Picture plots a certain histone modification state of the specified cell type. </li>
  <li>Zoom  button: Zoom in or zoom out to view the picture</li>
<p>&nbsp;</p>
<h3>7.Mrna Data Page</h3>
<img src="img/mrna.png" alt="" width="681" />
<li>Cell Type: It is required to select one or more cell types. </li>

<li>
Chromosome: Visualize genome-wide histone expression data by chromosome.</li>

<h3> 8.Download Page</h3>

<p><img src="img/download.png" alt="" width="681" />
    </p>
...
<li>Histone modification: Specify the histone modification type.</li>
<li>chr: Specify the chromosome.</li>

<h3>Some Common Questions</h3>
<div id="dfdf" style="margin-left:0px"><iframe width="1018" height="380" frameborder="0" src="jiaoben3311/index.html"   ></iframe></div>
</div>
  <div id="footer">
				<p><img src="img/2.jpg" alt="" width="31" height="32" /><br />
