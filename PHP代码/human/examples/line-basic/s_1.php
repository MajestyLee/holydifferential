...
echo "<div id=\"dfdf\" style=\"width:1000px\"><iframe width=\"1500\" height=\"400\" src=\"examples/line-basic/index1.php\" scrolling=\"no\" ></iframe></div> ";
echo "<p></p>";
...
echo "</br>";
echo "
<input type=\"checkbox\" a href=\"#\"  onclick=\"window.open('s_1_1_out.php','go1','scrollbars=yes,top=100,left=0,resizable=yes,alwaysRaised=yes,z-look=yes,width=1238,height=350')\" value=\"Open in a new page\" name=\"B1\" >Export to CSV file";
echo "<p></p>";
if($arrayc[0]!=null)
{//ifififif
    $a0=$chr;//chr
	...
	/* echo "<table summary=\"Demo of the included table styles\">
	<caption>
		</caption>
		<thead>
			<tr>";
	...
	/*if($i==0)
		...
		if($tt==0){
			echo"<p>Wrong region input or empty result</p>";
		}
		//echo"</tbody>
			//</table>"	;             
